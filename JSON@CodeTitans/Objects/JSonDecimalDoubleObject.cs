...
{
    internal class JSonDecimalDoubleObject : JSonDecimalObject, IJSonWritable
    {
        ...
        {
            return new JSonMutableDecimalDoubleObject(_data);
        }

        protected override IJSonObject GetImmutableCopy()
        {
            return new JSonDecimalDoubleObject(_data);
        }
        ...
        {
            return Math.Abs(_data) > EpsilonDouble;
        }
