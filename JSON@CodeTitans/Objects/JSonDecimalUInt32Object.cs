...
{
    internal class JSonDecimalUInt32Object : JSonDecimalObject, IJSonWritable
    {
        ...
        /// Init constructor.
        /// </summary>
        public JSonDecimalUInt32Object(UInt32 data)
        {
            _data = data;
        }
        ...
        {
            return new JSonMutableDecimalUInt32Object(_data);
        }

        protected override IJSonObject GetImmutableCopy()
        {
            return new JSonDecimalUInt32Object(_data);
        }
