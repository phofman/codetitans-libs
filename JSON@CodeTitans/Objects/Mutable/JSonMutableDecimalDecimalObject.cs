...
{
    internal sealed class JSonMutableDecimalDecimalObject : JSonDecimalDecimalObject, IJSonMutableObject
    {
        public JSonMutableDecimalDecimalObject(Decimal data)
            : base(data)
        {
        }
        ...
        {
            Data = value ? Decimal.One : Decimal.Zero;
        }
        ...
        {
            Data = value != null ? value.DecimalValue : Decimal.Zero;
        }
