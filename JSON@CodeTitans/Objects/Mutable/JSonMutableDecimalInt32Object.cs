...
{
    internal sealed class JSonMutableDecimalInt32Object : JSonDecimalInt32Object, IJSonMutableObject
    {
        public JSonMutableDecimalInt32Object(int data)
            : base(data)
        {
        }
        ...
        {
            Data = (Int32) DateTimeHelper.ToNumber(value, JSonDateTimeKind.Default);
        }
