...
{
    internal sealed class JSonMutableDecimalSingleObject : JSonDecimalSingleObject, IJSonMutableObject
    {
        public JSonMutableDecimalSingleObject(float data)
            : base(data)
        {
        }
        ...
        {
            Data = value != null ? value.SingleValue : 0f;
        }
