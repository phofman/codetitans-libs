...
{
    internal sealed class JSonMutableDecimalUInt32Object : JSonDecimalUInt32Object, IJSonMutableObject
    {
        public JSonMutableDecimalUInt32Object(UInt32 data)
            : base(data)
        {
        }
        ...
        {
            Data = (UInt32) DateTimeHelper.ToNumber(value, JSonDateTimeKind.Default);
        }
        ...
        {
            Data = value != null ? value.UInt32Value : 0u;
        }
